...
public record InitialDeployRequestDTO(IPlayer player, List<String> deployableZones, Map<ITokenType, Integer> tokenDeploy) implements IDeployRequestDTO {

    public InitialDeployRequestDTO(IPlayer player, List<String> deployableZones, int tokensToDeploy) {
        this(player, deployableZones, Map.of(ERisikoNewToken.TANK, tokensToDeploy));
    }
}
