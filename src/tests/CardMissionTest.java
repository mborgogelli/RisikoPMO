...
import model.versions.risikockassic.card.EnumMissionTypeCard;
...
//      List<String> missions = EnumMissionTypeCard.getMissionCards.();
//     
...
//      assert missions.size() == EnumMissionTypeCard.values().length : "Il numero dimissioni dovrebbe corrispondere al numero di enum";
//    
//    
